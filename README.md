...
| ------------- |-----------|
| Distributions | [] |
| Issues        | [![Open issues](https://img.shields.io/github/issues-search/nijave/otel-agent-trace-connector?query=is%3Aissue%20is%3Aopen%20label%3Aconnector%2Fotel-agent-trace-%20&label=open&color=orange&logo=opentelemetry)](https://github.com/nijave/otel-agent-trace-connector/issues?q=is%3Aopen+is%3Aissue+label%3Aconnector%2Fotel-agent-trace-) [![Closed issues](https://img.shields.io/github/issues-search/nijave/otel-agent-trace-connector?query=is%3Aissue%20is%3Aclosed%20label%3Aconnector%2Fotel-agent-trace-%20&label=closed&color=blue&logo=opentelemetry)](https://github.com/nijave/otel-agent-trace-connector/issues?q=is%3Aclosed+is%3Aissue+label%3Aconnector%2Fotel-agent-trace-) |
